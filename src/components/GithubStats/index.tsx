  ...
  return (
    <div className="w-full space-y-8 sm:space-y-10">
      ...
      <FadeIn direction="up" delay={50} duration={600}>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-4 sm:pb-5">
          <div className="space-y-1.5">
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              {/* GitHub SVG Icon */}
              <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white shrink-0" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
          ...
          {/* <a
            ...
            className="group inline-flex items-center justify-center self-start sm:self-auto gap-2 border border-emerald-400/40 bg-emerald-950/40 px-3.5 py-2 sm:px-4 sm:py-2 font-mono text-xs sm:text-sm text-emerald-300 font-medium transition-all duration-300 hover:border-emerald-400 hover:bg-emerald-900/50 hover:text-white hover:shadow-[0_0_15px_rgba(52,211,153,0.2)]"
          >
